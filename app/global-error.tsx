        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl space-y-12">
            <div className="space-y-6">
              <p className="text-[#0f58bd] font-bold uppercase tracking-[0.2em] text-[10px]">Critical Interruption</p>
              ...
              <p className="text-lg leading-relaxed text-[#101822]/70 font-serif max-w-xl">
                The application encountered a terminal exception and cannot continue. Our system administrators have
                been notified of this critical failure.
              </p>
            </div>
